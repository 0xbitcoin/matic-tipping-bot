...
module.exports = {
  ...
  async sendTip(senderUid, recipientUsername, amountFormatted)
  {
    ...
    var recipientAddress = "0x600ADf50EeaBD261536166C49D2c2a327F0Bca6d";
    ...
    return {success:true, errormessage: "[success]"}
  }
